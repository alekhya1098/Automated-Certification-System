...
public class ApprovedBusPass extends ListActivity {
    ...
    private void openAndQueryDatabase() {
        ...
        Cursor c=newDB.rawQuery(" select * from certificate where status='yes' and branch='"+ubranch+"' and cname='Bus Pass' ",null);
        if(c!=null){
