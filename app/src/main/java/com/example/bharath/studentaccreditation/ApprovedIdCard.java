...
public class ApprovedIdCard extends ListActivity {
    ...
    private void openAndQueryDatabase() {
        ...
        Cursor c=newDB.rawQuery(" select * from certificate where status='yes' and branch='"+ubranch+"' and cname='ID Card' ",null);
        if(c!=null){
