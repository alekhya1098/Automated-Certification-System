...
public class BusPassYes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_pass_yes);
        ...
        Toast.makeText(getApplicationContext(), "Bus Pass Approved", Toast.LENGTH_LONG).show();
