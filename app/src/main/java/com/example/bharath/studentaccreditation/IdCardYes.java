...
public class IdCardYes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_id_card_yes);
        ...
        Toast.makeText(getApplicationContext(), "ID Card Approved", Toast.LENGTH_LONG).show();
