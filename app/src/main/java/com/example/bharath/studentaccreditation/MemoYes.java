...
public class MemoYes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memo_yes);
        ...
        Toast.makeText(getApplicationContext(), "Memo Approved", Toast.LENGTH_LONG).show();
