...
public class ViewIdCard extends ListActivity {
    ...
    private void displayResultList() {
        ...
        tView.setText("Approve ID Cards");
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, final long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(ViewIdCard.this);
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent anotherActivityIntent = new Intent(getApplicationContext(), IdCardYes.class);
                ...
                dialog.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent anotherActivityIntent = new Intent(getApplicationContext(), ViewIdCard.class);
    ...
    private void openAndQueryDatabase() {
        ...
        Cursor c=newDB.rawQuery(" select * from certificate where status='Waiting' and branch='"+ubranch+"' and cname='ID Card' ",null);
        if(c!=null){
