...
public class ViewMemo extends ListActivity {
    ...
    private void displayResultList() {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, final long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(ViewMemo.this);
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent anotherActivityIntent = new Intent(getApplicationContext(), MemoYes.class);
                ...
                dialog.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent anotherActivityIntent = new Intent(getApplicationContext(), ViewMemo.class);
    ...
    private void openAndQueryDatabase() {
        ...
        Cursor c=newDB.rawQuery(" select * from certificate where status='Waiting' and branch='"+ubranch+"' and cname='Memo' ",null);
        if(c!=null){
